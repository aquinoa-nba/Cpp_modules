...
{
	std::cout << std::endl << "CL4P-TP " << _name <<  B_WHITE " created" NO_COLOR << std::endl;
}

ClapTrap::ClapTrap(ClapTrap const &other)
{
	std::cout << B_WHITE "Copy constructor for CL4P-TP called" NO_COLOR << std::endl;
	*this = other;
}
...
{
	std::cout << "CL4P-TP " B_YELLOW << _name << NO_COLOR " attacks " B_PURPLE << target \
...
{
	std::cout << "Assignation operator for CL4P-TP called" << std::endl;
	if (this != &other)
	{
